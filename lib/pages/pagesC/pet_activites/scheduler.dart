...
// GetX의 상태 관리를 위한 TaskController 인스턴스를 찾습니다.
  ...
  final UserController _userController = Get.put(UserController()); // UserController 인스턴스 생성
  ...
  AppBar _appBar() {
    return AppBar(
      ...
      actions: [
        ...
        Obx(() {
          return CircleAvatar(
            backgroundImage: _userController.userProfileImage.value.isNotEmpty
                ? NetworkImage(_userController.userProfileImage.value)
